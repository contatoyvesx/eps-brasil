  ...
  return (
    <section id="portfolio" className="py-24 bg-muted relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 justify-items-center">
          {regions.map((region) => (
            <Card
              key={region.title}
              className="group h-full overflow-hidden border-border/70 bg-card/80 backdrop-blur-xl shadow-lg shadow-primary/10 transition-transform duration-500 hover:-translate-y-2 shine-on-hover w-full max-w-full sm:max-w-[320px] lg:max-w-[360px] mx-auto"
            >
